...
RUN cd /opt && wget -q http://www.us.apache.org/dist/activemq/activemq-artemis/1.0.0/apache-artemis-1.0.0-bin.tar.gz && \
  wget -q http://apache.org/dist/activemq/activemq-artemis/1.0.0/apache-artemis-1.0.0-bin.tar.gz.asc && \
